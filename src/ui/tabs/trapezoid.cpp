...
TrapezoidTab::TrapezoidTab(QWidget* parent) : QWidget(parent) {
    setupUi();
}

void TrapezoidTab::setupUi() {
    ...
    QLabel* titleLabel = new QLabel("Метод трапеций");
    ...
    QObject::connect(m_calculate_button, &QPushButton::clicked, this, &TrapezoidTab::calculate);

    setLayout(mainLayout);
}

void TrapezoidTab::calculate() {
    ...
    double result = integral::trapezoid(a, b, n);
